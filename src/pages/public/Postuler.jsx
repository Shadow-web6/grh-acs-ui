    ...
    <div className="min-h-screen bg-gray-50 py-12 px-4">
      ...
      <div className="max-w-3xl mx-auto">
        <div className="text-center mb-10">
          <div className="inline-flex items-center justify-center w-16 h-16 bg-[#129547] rounded-2xl mb-4">
          ...
          <div className="bg-white border border-gray-200 rounded-2xl p-8 shadow-sm">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <button
                type="submit"
                disabled={submitting}
                className="w-full bg-[#129547] text-white py-3 rounded-xl font-medium hover:bg-[#0E7739] transition disabled:opacity-50"
              >
            ...
            {offres.map(offre => (
              <div key={offre.id} className="bg-white border border-gray-200 rounded-2xl p-6 shadow-sm">
                <div className="flex justify-between items-start mb-3">
                  ...
                  <span className="bg-blue-50 text-[#129547] text-xs font-medium px-3 py-1 rounded-full">
                    {offre.type_contrat}
                  </span>
                </div>
                ...
                <button
                  ...
                  className="bg-[#129547] text-white px-5 py-2.5 rounded-xl text-sm font-medium hover:bg-[#0E7739] transition"
                >
                  Postuler
                </button>
              </div>
